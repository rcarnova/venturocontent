...
{"pillar":"uno dei 4 pillar","angolo":"angolo strategico Venturo in 1 frase","linkedin_long":{"testo":"post 800-1200 caratteri: hook breve, sviluppo, domanda finale. Tono Venturo. A capo per respirare.","hashtag":["#tag1","#tag2","#tag3"]},"linkedin_short":{"testo":"max 300 caratteri. Una tensione o domanda.","hashtag":["#tag1","#tag2"]},"twitter":{"testo":"max 240 caratteri. Aforisma o domanda netta."},"substack":{"titolo":"titolo newsletter Venturo","intro":"150-200 parole. Apre riflessione, non dà risposte."},"image_prompt":"prompt Midjourney in italiano per un billboard nel deserto. Struttura: [parola chiave concettuale del post] scritta su un billboard classico americano, deserto arido, luce radente dorata o crepuscolare, fotografia editoriale, atmosfera Prada Marfa. Stile: qualità fotografica analogica, colori desaturati con un accento cromatico, cielo vasto, nessuna persona. Concludi sempre con: --ar 16:9 --v 6.1 --style raw"}`;
